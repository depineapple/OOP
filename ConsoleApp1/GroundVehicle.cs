...
namespace ConsoleApp1
{
    public abstract class GroundVehicle: Vehicle
    {
        ...
        { 
            ...
            set
            {
                if (value > maxSpeed) maxSpeed = 443;
            }
        }

        public GroundVehicle(string vehicleType, int peopleCapacity, int minSpeed, int maxSpeed) : base(vehicleType, peopleCapacity) 
        {
